                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between border-bottom pb-3 mb-3">
                                ...
                                <span class="fw-bold">${reservation.formattedDateHeureDebut}</span>
                            </div>
                            <div class="d-flex justify-content-between border-bottom pb-3 mb-3">
                                <span class="text-muted">Date de fin</span>
                                <span class="fw-bold">${reservation.formattedDateHeureFin}</span>
                            </div>
                            <div class="d-flex justify-content-between border-bottom pb-3 mb-3">
                            ...
                            <div class="d-flex justify-content-between align-items-center pt-2">
                                ...
                                <span class="fw-bold text-primary fs-3">
                                    <fmt:formatNumber value="${reservation.montantTotal}" type="number"
