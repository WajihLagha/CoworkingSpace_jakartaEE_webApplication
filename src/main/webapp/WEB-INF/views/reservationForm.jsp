            ...
            <div class="container" style="max-width: 800px;">
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="fw-bold">
                                    <c:choose>
                                        ...
                                        <c:when test="${espace.typeEspace == 'SALLE_REUNION'}">Salle de Reunion</c:when>
                                ...
                                <div class="fw-bold text-primary fs-5">
                                    <c:choose>
                                        <c:when test="${sessionScope.utilisateur.typeUtilisateur == 'ETUDIANT'}">
                                            <span class="text-decoration-line-through text-muted fs-6 me-2">${prixBase}
                                                EUR</span>
                                            ${prixReduit} EUR/h
                ...
                <form action="${pageContext.request.contextPath}/reservation" method="post" class="needs-validation"
                    ...
                    <c:if test="${not empty supplements}">
                        <div class="card border-0 shadow-sm mb-4">
                            <div class="card-header bg-white py-3">
                                <h5 class="mb-0 fw-bold"><i class="bi bi-plus-circle me-2"></i>Supplements optionnels
                                </h5>
                            </div>
                            <div class="card-body">
                                <div class="row g-3">
                                            ...
                                            <div class="form-check p-3 border rounded bg-light h-100">
                                                ...
                                                <label class="form-check-label w-100" for="supp_${supplement.id}">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <span class="badge bg-primary rounded-pill">+${supplement.prix}
                                                            EUR</span>
                                                    </div>
                                                </label>
                                            </div>
